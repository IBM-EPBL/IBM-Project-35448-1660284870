...
API_KEY = "XHVCpkWOGGom83uCp7out9JTdKO3eSQAoPIfEQTxc5fa"
...
def load_model(file='"C:\Users\Rishi\Documents\Car Resale value prediction\Flask\resale_model.sav"'):#load the saved model
	return pickle.load(open(file, 'rb'))

@app.route('/')
def index():#main page
	return render_template('DGCT CAR VALUES.html')
